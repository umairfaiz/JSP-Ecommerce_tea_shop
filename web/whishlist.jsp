<%-- 
    Document   : whishlist
    Created on : Dec 14, 2016, 6:25:42 PM
    Author     : Admin
--%>
...
<html lang="en">
  <head>
    ...
    <title>Hela~Tae | Wishlist Page</title>
           ...
           <div class="cart-view-table aa-wishlist-table">
               ...
               <div class="table-responsive">
                  <table class="table">
                   ...
                   <sql:query var="wishList"  dataSource="${db}">
                       SELECT * FROM UMAIR.WISHLISTDETAILS where USEREMAIL='${myCust.customerEmail}'
                   </sql:query>
                   <c:forEach items="${wishList.rows}" var="i">
                      <tr>
                          <input type="hidden" name="itemID" value="${i.itemid}" >
                          <input type="hidden" name="itemcost" value="${i.productcost}" >
                           <input type="hidden" name="useremail" value="${myCust.customerEmail}">
                           <td><button class="remove" type="submit" name="wishlist" value="removelist"><fa class="fa fa-close"></fa></button></td>
                        <td><a href="#"><img src="img/products/${i.itemid}.png" alt="img"></a></td>
                        <td><a class="aa-cart-title" href="#">${i.itemname}</a></td>
                        <input type="hidden" name="itemname" value="${i.itemname}">
                        <td>${i.productcost}</td>
                        <td><button class="aa-add-to-cart-btn" type="submit" name="addtolist" value="addlist">Add To Cart</button></td>
                      </tr>   
                    </c:forEach>   
                  </table>
                </div>
