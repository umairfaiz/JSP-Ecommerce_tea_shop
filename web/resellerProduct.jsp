<%-- 
    Document   : resellerProduct
    Created on : Jan 1, 2017, 9:06:44 PM
    Author     : Admin
--%>
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  <c:if test="${loginstate !=null}" >
                   ...
                   <li class="hidden-xs"><a href="bidding.jsp?loginstate=1" >Bid</a></li>
            ...
            <div class="aa-product-catg-body" id="list-catg">
                ...
                <ul class="aa-product-catg">
                    ...
                    <sql:query var="itemsList"  dataSource="${db}">
                        SELECT * FROM ITEM where ITEMCATE='Repremium'
                    </sql:query>
              ...
              <nav>
                <ul class="pagination">
                  <li><a href="resellerProduct.jsp?loginstate=1">1</a></li>
                  <li><a href="resellerIcedTea.jsp?loginstate=1">2</a></li>
                </ul>
              </nav>
            </div>
          </div>
