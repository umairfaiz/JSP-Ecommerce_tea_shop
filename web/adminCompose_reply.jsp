<%-- 
    Document   : adminCompose_reply
    Created on : Dec 29, 2016, 11:35:55 AM
    Author     : Admin
--%>
...
<html lang="en">
  <head>
    ...
    <title>Hela~Tae | Reply page</title>
             ...
             <div class="row">
               <div class="col-md-8">
                 <div class="aa-contact-address-left">
                     ...
                     <form class="comments-form contact-form" action="adminInquiryServlet" method="POST">
                         
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">                        
                            <input type="text" name="adminname"placeholder="Your Name" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">                        
                            <input type="email" name="adminemail"placeholder="Your Email" class="form-control">
                        </div>
                      </div>
                    </div>
                     <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">                        
                         ...
                         <div class="col-md-6">
                             <div class="form-group">                        
                                 <input type="text" name="receivEmail" placeholder="Customer Email" class="form-control">
                             </div>
                         </div>
                    </div>                  
                     
                    <div class="form-group">                        
                      <textarea class="form-control" rows="3" name="replyMsg" placeholder="Message"></textarea>
                    </div>
