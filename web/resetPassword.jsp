<%-- 
    ...
    Created on : Dec 20, 2016, 10:22:35 PM
    Author     : Admin
--%>
...
<html lang="en">
  <head>
    ...
    <title>Hela~Tae | Password reset Page</title>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="aa-myaccount-register">                 
                 ...
                 <form action="resetUserPwdServlet"  method ="POST" class="aa-login-form">
                    <p><c:set var="resetSucc" scope="request" value="${param.resetSucc}"/>
                    <c:if test="${resetSucc != null}">
                        <br/><font color="RED">Password was changed successfully!</font>
                    </c:if>  
                    </p>
                    <p><c:set var="pwdMatch" scope="request" value="${param.pwdMatch}"/>
                    <c:if test="${pwdMatch != null}">
                        <br/><font color="RED">Passwords entered does not match!</font>
                    </c:if>  
                    </p>
                    <p><c:set var="resetFail" scope="request" value="${param.resetFail}"/>
                    <c:if test="${resetFail != null}">
                        <br/><font color="RED">Check your email And try again.</font>
                    </c:if>  
                    </p>
                    <label>Email<span>*</span></label>
                    <input type="text" name ="email" placeholder="Verify Email">
                    ...
                    <input type="password" name ="pwd" placeholder="Verify new password">
                    ...
                    <button type="submit" value="SignIn"class="aa-browse-btn">Reset</button>
                  </form>
                </div>
              </div>
            </div>          
