<%-- 
    Document   : updateUser
    Created on : Dec 20, 2016, 7:51:32 PM
    Author     : Admin
--%>
...
<html lang="en">
  <head>
    ...
    <title>Hela~Tae | Update Information Page</title>
 ...
 <!-- SCROLL TOP BUTTON -->
  ...
  <section id="aa-catg-head-banner">
    <img src="img/pages/updateinfo.jpg" alt="fashion img">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="aa-myaccount-register">                 
                 ...
                 <h5><p>Enter updated information in the below fields.</p></h5>
                 <form action="updateUserInfoServlet"  method ="POST" class="aa-login-form">
                    <p><c:set var="noEmail" scope="request" value="${param.noEmail}"/>
                    <c:if test="${noEmail != null}">
                        <br/><font color="RED">Check your email And try again.</font>
                    </c:if>  
                    </p>
                    <p><c:set var="updateSucc" scope="request" value="${param.updateSucc}"/>
                    <c:if test="${updateSucc != null}">
                        <br/><font color="RED">Information was updated successfully!!</font>
                    </c:if>  
                    </p>
                    <label>Email<span>*</span></label>
                    <input type="text" name ="email" placeholder="Verify Email">
                    <label>Shipping address<span>*</span></label>
                    <input type="text" name ="address" placeholder="New Shipping address">
                    <label>Change Password<span>*</span></label>
                    <input type="password" name ="pwd" placeholder="New password">
                    <label>Card number<span>*</span></label>
                    <input type="text" name = "cardDetails" placeholder="New Card number">
                    ...
                    <button type="submit" value="SignIn"class="aa-browse-btn">Update</button>
                  </form>
                </div>
              </div>
            </div>          
