<%-- 
    ...
    Created on : Dec 27, 2016, 9:46:58 PM
    Author     : Admin
--%>
...
<html lang="en">
  <head>
    ...
    <title>Hela~Tae | Update Member Page</title>
              ...
              <div class="col-md-6">
                <div class="aa-myaccount-register">                 
                 ...
                 <form action="memberServlet"  method ="POST" class="aa-login-form">
                    ...
                    <label>Add points<span>*</span></label>
                    <input type="text" name ="point" placeholder="Add points based on purchases">
                  
                    <a><input type="hidden" name="updatememeber" value="update"/><button type="submit" value="SignIn"class="aa-browse-btn">Reset</button></a>
                  </form>
                </div>
              </div>
            </div>          
