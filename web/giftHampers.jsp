<%-- 
    Document   : giftHampers
    Created on : Jan 3, 2017, 3:49:09 AM
    Author     : Admin
--%>
...
<html lang="en">
  <head>
    ...
    <title>Daily Shop | Gifts & Accessories</title>
 ...
 <!-- SCROLL TOP BUTTON -->
  ...
  <section id="aa-catg-head-banner">
   <img src="img/pages/gift.jpg" alt="fashion img">
            ...
            <div class="aa-product-catg-body" id="list-catg">
                ...
                <ul class="aa-product-catg">
                    ...
                    <sql:query var="itemsList"  dataSource="${db}">
                        SELECT * FROM ITEM where ITEMCATE='gifts'
                    </sql:query>
                        ...
                        <li>
                            ...
                            <figure>  
                                ...
                                <div class="aa-product-hvr-content">
                                    <c:if test="${loginstate !=null}">
                                                    <button data-toggle="tooltip" data-placement="top" title="Add to Wishlist" type="hidden" name="wishlist" value="list"><span class="fa fa-heart-o"></span></button>
                                    </c:if>
              ...
              <nav>
                <ul class="pagination">
                  <li><a href="product.jsp?loginstate=1">1</a></li>
                  <li><a href="icedTea.jsp?loginstate=1">2</a></li>
                  <li><a href="giftHampers.jsp?loginstate=1">3</a></li>
                </ul>
              </nav>
            </div>
          </div>
