<%-- 
    Document   : resellerIcedTea
    Created on : Jan 1, 2017, 11:05:57 PM
    Author     : Admin
--%>
...
<html lang="en">
  <head>
    ...
    <title>Daily Shop | Reseller Product Page</title>
 ...
 <!-- SCROLL TOP BUTTON -->
            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  <c:set var="loginstate" scope="request" value="${param.loginstate}"/>
                  <c:if test="${loginstate !=null}" >
                  <li><a href="resellerProduct.jsp?loginstate=1">Home</a></li>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                <!-- Text based logo -->
                <a href="resellerProduct.jsp?loginstate=1">
  ...
  <section id="aa-catg-head-banner">
   <img src="img/pages/resellerIced.jpg" alt="fashion img">
   <div class="aa-catg-head-banner-area">
     <div class="container">
      <div class="aa-catg-head-banner-content">
        <h2>Reseller Iced Tea<</h2>
      </div>
     </div>
   </div>
  </section>
            ...
            <div class="aa-product-catg-body" id="list-catg">
                ...
                <ul class="aa-product-catg">
                    ...
                    <sql:query var="itemsList"  dataSource="${db}">
                        SELECT * FROM ITEM where ITEMCATE='Reiced'
                    </sql:query>
                    <c:forEach items="${itemsList.rows}" var="i">
                        <li>
                            <form action="cartServlet" method ="POST">
                            <figure>  
                                <a class="aa-product-img" href="#"><img src="img/products/${i.itemid}.png" alt=""></a>
                                ...
                                <c:if test="${loginstate !=null}">  
                                <a class="aa-add-card-btn"><span class="fa fa-shopping-cart"></span><input type="hidden" name="addReseller" value="addReseller/><button type="submit" style="background: black; border: none">Add To Cart</button></a>
                                </c:if>
                                <div class="aa-product-hvr-content">
                                    <c:if test="${loginstate !=null}">
                                                    <button data-toggle="tooltip" data-placement="top" title="Add to Wishlist" type="hidden" name="wishlistReseller" value="Relist"><span class="fa fa-heart-o"></span></button>
                                    </c:if>

                                </div>
                                <figcaption>
                                    <h5 class="aa-product-title"><input type="text" name="itemname" value="${i.itemname}" readonly style="border:none; width:300px"/></h5>
                                    <span class="aa-product-price"><input type="text" name="price" value="${i.price}" readonly style="border:none; width:300px"/></span>
                                    <p class="aa-product-descrip" ><input type="hidden" name="description" value="${i.itemdescription}"/>${i.itemdescription}</p>
              ...
              <nav>
                <ul class="pagination">
                  <li><a href="resellerProduct.jsp">1</a></li>
                  <li><a href="resellerIcedTea.jsp">2</a></li>
                  <li><a href="#">3</a></li>
                  <li><a href="#">4</a></li>
                </ul>
              </nav>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  ...
                  <ul class="aa-footer-nav">
                    <li><a href="index.jsp?loginstate=1">Home</a></li>
                    <li><a href="product.jsp?loginstate=1">Our Products</a></li>
                    <li><a href="contact.jsp?loginstate=1">Contact Us</a></li>
                  </ul>
                </div>
              </div>
              <div class="col-md-3 col-sm-6">
